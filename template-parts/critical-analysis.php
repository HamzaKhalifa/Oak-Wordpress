<div class="dawn__admin_analysis">
    <h3>Analyse Critique</h3>

    <div class="dawn_admin_analysis__list">
        <div class="dawn_admin_analysis_list__tile_container">
            <h2 class="dawn_admin_analysis_list_tile_container__tile">Liste des Analyses Critiques</h2>
            <div class="dawn_admin_analysis_list_tile_container__add_analysis_button">
                <span class="dawn_admin_analysis_list_tile_container_add_analysis_button__text" >
                    Ajouter
                </span>
            </div>
        </div>
    ...
    <div class="dawn_admin_analysis__modals_container">
        <div class="dawn_admin_analysis_modals_container__add_modal">
            <div class="dawn_admin_analysis_modals_container_add_modal__title_container">
                <h3 class="dawn_admin_analysis_modals_container_add_modal_title_container__title">Ajouter une nouvelle Analyse de Reporting</h3>
            </div>
            <input type="text" name="" id="" placeholder="Titre" class="dawn_admin_analysis_modals_container_add_modal__input">
            <span class="dawn_admin_analysis_modals_container_add_modal__error"></span>
            <div class="dawn_admin_analysis_modals_container_add_modal__buttons_container">
                <div class="dawn_admin_analysis_modals_container_add_modal__cancel_button">
                    <span class="dawn_admin_analysis_modals_container_add_modal_cancel_button__text" >
                        Annuler
                    </span>
                </div>
                
                <div class="dawn_admin_analysis_modals_container_add_modal__add_button">
                    <span class="dawn_admin_analysis_modals_container_add_modal_add_button__text" >
                        Ajouter
                    </span>
                </div>
            </div>
    ...
    <div class="dawn_admin_analysis__save_container">
        <i class="fas fa-save"></i>
        <span class="dawn_admin_analysis_save_container__text">Sauvegarder</span>
    </div>
