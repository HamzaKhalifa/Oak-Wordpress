<div class="oak_fields_list_top_container">
    ...
    <div class="oak_add_field_container__fields_list">
        ...
        foreach( Oak::$objects as $object ) : 
            $exists = false;
            foreach( $added_objects as $added_object ) :
                if ( $object->object_identifier == $added_object->object_identifier ) 
                    $exists = true;
            endforeach;
            if ( !$exists ) :
        ...
        ?>
            <div class="oak_list_row">
                <div class="oak_list_row__container">
                    <input class="oak_list_titles_container__checkbox" type="checkbox">
                    <span class="oak_list_titles_container__title"><?php echo( $object->object_designation ); ?></span>
                </div>
                ...
                <div class="oak_list_row__container">
                    <span class="oak_list_titles_container__title"><?php echo( $object->object_identifier ); ?></span>
                </div>
                
                <div class="oak_list_row__container">
                    <div class="<?php if ( $object->object_selector ) : echo('oak_dot'); else : echo('oak_dot_false'); endif; ?>"></div>
                </div>

                <div class="oak_list_row__container">
                    <div class="<?php if ( $object->object_selector ) : echo('oak_dot'); else : echo('oak_dot_false'); endif; ?>"></div>
                    <span object-identifier="<?php echo( $object->object_identifier ); ?>" class="oak_list_header__add_button oak_list_button oak_add_field_container_saved_field_container__update_button"><?php _e( 'Accéder', Oak::$text_domain ); ?></span>
                </div>
