<div class="oak_fields_list_top_container">
    <div class="oak_list_header">
        ...
        <h1><?php _e( 'Indicateurs Qualitatifs', Oak::$text_domain ); ?></h1>
    ...
    <div class="oak_add_field_container__fields_list">
        ...
        foreach( $qualis as $quali ) : 
            $exists = false;
            foreach( $added_qualis as $added_quali ) :
                if ( $quali->quali_identifier == $added_quali->quali_identifier ) 
                    $exists = true;
            endforeach;
            if ( !$exists ) :
                $added_qualis[] = $quali;
        ?>
            <div class="oak_list_row">
                <div class="oak_list_row__container">
                    <input class="oak_list_titles_container__checkbox" type="checkbox">
                    <span class="oak_list_titles_container__title"><?php echo( $quali->quali_designation ); ?></span>
                </div>

                <div class="oak_list_row__container">
                    <span class="oak_list_titles_container__title"><?php echo( $quali->quali_publication ); ?></span>
                </div>

                <div class="oak_list_row__container">
                    <span class="oak_list_titles_container__title"><?php echo( $quali->quali_object ); ?></span>
                </div>
                
                <div class="oak_list_row__container">
                    <div class="<?php if ( $quali->quali_selector ) : echo('oak_dot'); else : echo('oak_dot_false'); endif; ?>"></div>
                </div>

                <div class="oak_list_row__container">
                    <div class="<?php if ( $quali->quali_selector ) : echo('oak_dot'); else : echo('oak_dot_false'); endif; ?>"></div>
                    <span quali-identifier="<?php echo( $quali->quali_identifier ); ?>" class="oak_list_header__add_button oak_list_button oak_add_field_container_saved_field_container__update_button"><?php _e( 'Accéder', Oak::$text_domain ); ?></span>
                </div>
