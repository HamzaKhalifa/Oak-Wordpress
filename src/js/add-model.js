...
addFormButton.addEventListener('click', function() {
    ...
    + '</select>'
    + '</div> <div class="oak_add_model_forms_list__vertical"> <label class="oak_add_other_element_label" for="type">Attributs</label>'
    + '<select class="oak_add_model_forms_list_horizontal__attributes_select" name="type" id=""><option value=""></option>'
    + '</select></div></div><div class="oak_add_model_forms_list__horizontal"><div class="oak_add_model_forms_list__vertical.oak_left_element">'
    + '<label class="oak_add_other_element_label" for="field-designation">Désignation du formulaire</label><select class="oak_add_model_forms_list_horizontal__designation_select" name="field-designation" id=""></select></div>'
    + '<div class="oak_add_model_forms_list__vertical"><label class="oak_add_other_element_label" for="form-identifier">Identifiant Unique</label><input disabled name="field-identifier" type="text" value="" class="oak_add_field_container__input oak_add_model_field_identifier"></div></div>'
    + '<div class="oak_add_model_forms_list__horizontal"><div class="oak_add_model_forms_list__horizontal.oak_left_element"><label class="oak_add_other_element_label" for="field-identifier">Renommer</label><input name="field-identifier" type="text" value="" class="oak_add_field_container__input oak_add_model_form_rename"></div>'
    + '<div class="oak_add_model_forms_list__horizontal">'
